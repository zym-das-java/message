...
function checkharvest_time(){
	var a=$("input[name=harvest_time ]").val();
	$("#harvest_time").html("");
	console.log(a)
	if(a==0){
...
function checksampling_time(){
	var a=$("input[name=sampling_time ]").val();
	console.log(a)
	$("#sampling_time").html("");
	if(a==0){
...
function sub(){
	...
	if(ss>0){
		console.log(ok1,ok2,ok3,ok4,ok5,ok6,ok7,ok8,ok9,ok10,ok11,ok12,ok13,ok14)
		if(ok1==true&&ok2==true&&ok3==true&&ok4==true&&ok5==true&&ok6==true&&ok7==true&&ok8==true&&ok9==true&&ok10==true&&ok11==true&&ok12==true&&ok13==true&&ok14==true){
		...
		console.log(ok1,ok2,ok3,ok4,ok5,ok6,ok7,ok8,ok9,ok10,ok11,ok12)
		if(ok1==true&&ok2==true&&ok3==true&&ok4==true&&ok5==true&&ok6==true&&ok7==true&&ok8==true&&ok9==true&&ok10==true&&ok11==true&&ok12){
			   var url = document.getElementById("search_form").action+="?cc="+cc;
